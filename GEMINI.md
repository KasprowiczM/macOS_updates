...
Automated macOS update system — Bash 3.2+ scripts + Python 3 backend, **Apple Silicon (arm64) only**, macOS 13–26, **v1.2.0**, 7 languages, multi-cloud private overlay via `dev_sync/`.

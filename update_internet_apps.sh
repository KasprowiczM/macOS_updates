...
STATUS_CLAUDE_APP="→ managed by Homebrew (update_brew.sh)"
STATUS_GEMINI="$L_INTERNET_STATUS_SKIPPED"
STATUS_COMET="→ managed by Homebrew (update_brew.sh)"
STATUS_PERPLEXITY="→ managed by Homebrew (update_brew.sh)"
STATUS_ANTIGRAVITY="→ managed by Homebrew (update_brew.sh)"
STATUS_ANTIGRAVITY_IDE="→ managed by Homebrew (update_brew.sh)"
...
STATUS_PROTONMAIL="→ managed by Homebrew (update_brew.sh)"
STATUS_PROTONDRIVE="→ managed by Homebrew (update_brew.sh)"
...
STATUS_WARP="→ managed by Homebrew (update_brew.sh)"
STATUS_CURSOR="→ managed by Homebrew (update_brew.sh)"

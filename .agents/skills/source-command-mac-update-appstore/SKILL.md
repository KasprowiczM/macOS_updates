---
name: "source-command-mac-update-appstore"
...
# source-command-mac-update-appstore

Use this skill when the user asks to run the migrated source command `mac-update-appstore`.

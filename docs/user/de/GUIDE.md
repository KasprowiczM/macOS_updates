...
macOS Updates automatisiert Updates auf **Apple-Silicon-Macs**:

1. macOS-System (`softwareupdate -ia -R`)
2. App Store (`sudo mas upgrade` + GUI für iPad-Apps)
3. Node/Bun und globale npm-CLIs
4. Homebrew
5. 40+ Internet-Apps — **nur wenn installiert**
6. `APPLICATIONS.md` und `UPDATES.md`

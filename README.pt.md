...
| 2 | **App Store** — `sudo mas upgrade` + alternativa com AppleScript |
| 3 | **CLI Nativos + npm** — Node, Bun, ferramentas globais npm |
| 4 | **Homebrew** — `brew upgrade` + limpeza |
| 5 | **Apps da Internet** — apenas se instalados (Chrome, VS Code, Microsoft 365, …) |
| 6 | **Pós-atualização** — atualiza as versões no `APPLICATIONS.md`, adiciona histórico ao `UPDATES.md` |
